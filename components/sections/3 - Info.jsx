          ...
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:gap-2 lg:items-center sm:space-y-0 mt-6">
                <a href="#" className=" inline-flex items-center justify-center px-5 py-2.5 font-medium rounded-lg text-white bg-gradient-to-br bg-white/15 border border-white/15 backdrop-blur-xl">
                  Donate Now
                </a>
                <a href="#" className=" inline-flex items-center justify-center px-5 py-2.5 font-medium rounded-lg text-white bg-gradient-to-br bg-white/15 border border-white/15 backdrop-blur-xl">
...
<div className=' h-fit relative sm:-mt-3 pb-48 sm:pb-0 '>
          <div className='aspect-square absolute bg-white/30 shadow-lg border border-neutral-200/20 rounded-xl h-96 -rotate-3 p-3 hover:z-10 backdrop-blur-md'>
          ...
          <div className='aspect-square absolute bg-white/30 shadow-lg border border-neutral-200/20 rounded-xl h-96 ml-24 p-3 -translate-y-3 hover:z-10 backdrop-blur-md'>
          ...
          <div className='aspect-square absolute bg-white/30 shadow-lg border border-neutral-200/20 rounded-xl h-96 ml-48 rotate-3 p-3 -translate-y-6 hover:z-10 backdrop-blur-md'>
