  ...
  return (
    <div className="overflow-hidden relative py-32 sm:py-40 w-full">
      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 px-6">
...
<div className=' h-fit relative sm:-mt-6 pb-48 sm:pb-0 '>
          <div className='aspect-square absolute bg-white/30 shadow-lg border border-neutral-200/20 rounded-xl h-96 -rotate-3 p-3 hover:z-10'>
          ...
          <div className='aspect-square absolute bg-white/30 shadow-lg border border-neutral-200/20 rounded-xl h-96 ml-24 p-3 -translate-y-3 hover:z-10'>
          ...
          <div className='aspect-square absolute bg-white/30 shadow-lg border border-neutral-200/20 rounded-xl h-96 ml-48 rotate-3 p-3 -translate-y-6 hover:z-10'>
