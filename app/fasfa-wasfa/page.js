...
export const metadata = {
  title: "Washington Youth Alliance | FAFSA & WASFA Resources",
  description:
    "Get comprehensive information about FAFSA and WASFA applications, eligibility requirements, and resources to help Washington students access financial aid for higher education.",
};
...
const features = [
  {
    ...
    purpose:
      "Determines your eligibility for federal grants, loans, and other financial aid.",
  },
  {
    name: "WASFA (Washington Application for State Financial Aid)",
    eligibility:
      "Undocumented individuals, those ineligible for FAFSA due to immigration status, and select applicants.",
    purpose:
      "Determines your eligibility for state grants, loans, and other financial aid.",
  },
];
      ...
      <div className=" py-12 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-black text-center mb-14 tracking-tight md:text-5xl bg-clip-text text-transparent bg-gradient-to-br to-[#0C4287] from-[#7268E7] py-1">
            <span className={bricolage_grotesque.className}>FASFA & WASFA</span>
          </h1>
          ...
          <div className="grid gap-8 mt-4">
            ...
            <div className="flex h-full flex-col justify-start items-start">
              ...
              <ol className="text-gray-600 list-disc list-inside">
                <li>
                  Student Signature: Sign the application electronically using
                  your FSA ID.
                </li>
                <li>
                  Deadlines Matter: Meeting your school&apos;s priority
                  deadline, making timely updates, and submitting additional
                  paperwork can significantly impact your financial aid
                </li>
              </ol>
            </div>
