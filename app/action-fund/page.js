...
const features = [
  {
    ...
    description:
      "The Washington Youth Alliance is entirely youth-led, with board members and staff all under the age of 30. This dynamic ensures that the initiatives remain relevant and impactful for young people",
  },
  {
    name: "Local Chapters",
    description:
      ...
      <div className=" py-12 sm:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-center mb-12 tracking-tight md:text-5xl bg-clip-text text-transparent bg-gradient-to-br to-[#0C4287] from-[#7268E7] py-1">
            <span className={bricolage_grotesque.className}>Quick Facts</span>
          </h1>
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-center mb-24 tracking-tight md:text-5xl bg-clip-text text-transparent bg-gradient-to-br to-[#0C4287] from-[#7268E7] py-1">
            <span className={bricolage_grotesque.className}>What We Do</span>
          </h1>
          <div className="grid grid-cols-1 gap-8 mt-12">
            <div className="flex flex-col gap-4">
              <p className="leading-8 text-gray-600">
                The Washington Youth Alliance empowers youth across Washington
                State by fostering essential life skills, promoting digital
                literacy, and preparing young people for educational and career
                success. We center our mission around the creation of youth-led
                chapters that advocate for crucial societal issues, including
                mental health, while ensuring that young people are
                well-equipped for the technological and professional demands of
                the future. Through community engagement and strategic
                partnerships, we strive to build a supportive framework that
                enables every young person to succeed and lead in their
                communities.
              </p>
            </div>
            <div className="flex flex-col gap-4">
              <p className="leading-8 text-gray-600">
                The terms student and youth are often used interchangeably, but
                this leaves out a significant youth population—the most
                vulnerable. Our strategic vision emphasizes focusing on all
                youth. This means we are eventually moving away from just
                school-based organizing work to focus on collective issues that
                impact youth outside of school. There are a lot of
                intersections: gun violence prevention, digital literacy, etc.
                There are also a lot of unique problems that youth who are not
                in the education system experience, like access to healthy food,
                career readiness that isn&apos;t going to college, and more. In
                particular, black and brown students face these barriers the
                most.
              </p>
            </div>
          </div>
