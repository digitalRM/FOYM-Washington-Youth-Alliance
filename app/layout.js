...
export const metadata = {
  ...
  description:
    "The Washington Youth Alliance is a youth-led organization that advocates for youth issues in Washington State.",
  openGraph: {
    title: "Washington Youth Alliance",
    description:
      "The Washington Youth Alliance is a youth-led organization that advocates for youth issues in Washington State.",
  ...
  return (
    <html lang="en">
      <body
        ...
        style={{ background: "#f5f5f5", overflowX: "hidden" }}
      >
        <div className=" scroll-smooth">{children}</div>
      </body>
      <GoogleAnalytics gaId="G-56K4X35618" />
    </html>
  );
}
